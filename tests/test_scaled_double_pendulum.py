...
def test_pendulum_update_model_applies_recovered_scale_factors(tmp_path):
    """
    ...
    ground positions are exact functions of the per-body scale factors:
    ...
    solver achieves on the raw scale factors.
    """
    true_b0_length = 1.25
    true_b1_length = 0.75
